    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="alert alert-success" role="alert"><span>You have a new proposed appointment.</span></div>
                <p style="margin: 10px;">[Person] has proposed an appointment for you in regards to [subject] at this
                    date and time: [date/time].</p>
                <div class="col">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6"><button class="btn btn-primary text-center" type="button">Accept
                                    Appointment</button></div>
                            <div class="col-md-6"><button class="btn btn-primary text-end" type="button">Deny
                                    Appointment</button></div>
                        </div>
                    </div>
                </div>
