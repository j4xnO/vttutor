...
if (isset($_POST["submit"])) {
    ...
    if (!$error) {
        ...
        //setcookie($timeSubmitted, date('m/d/y h:i:s a', time()), time() + 60 * 60 * 24 * 2);
        //redirect to success
        header("HTTP/1.1 307 Temprary Redirect");
        header("Location: QuestionsDashJO.php");
    }
}
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-1">Report An Inappropriate Comment Or Answer</h3>
                </div>
                            ...
                            <div class="col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                                <div class="card mb-5">
                                    <div class="card-body p-sm-5">
                                        <h2 class="text-center mb-4">Please Detail Why This Question Was Inappropriate</h2>
                                        <form method="post">
