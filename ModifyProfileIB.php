...
if ($accounttype == "student") {
        $sql = "update Student set studentname='$name', studentpwrd='$passwd', class1=$class1, class2= $class2 where studentemail='$email'";
        $result = $mydb->query($sql);
        if (isset($_POST["submit"])) { echo "Student record updated !";}
}
else {
        $sql = "update Tutor set tutorname='$name', tutorpwd='$passwd', class1=$class1, class2= $class2 where tutoremail='$email'";
        $result = $mydb->query($sql);
        if (isset($_POST["submit"])) { echo "Tutor record updated !"; }
}
                    ...
                    <div class="card mb-5">
                        <div class="card-body p-sm-5"><img src="assets/img/vt%20tutorR.png">
                            ...
                            <form method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
                                ...
                                <div class="mb-3"></div>
                                <input class="btn btn-primary d-block w-100" name="submit" type="submit" value="Update">
                            </form>
                            <br>
                            <br>
                            <a href="AccountManagementIB.php">Back to Account Management</a>
                        </div>
                    </div>
                </div>
            </div>
