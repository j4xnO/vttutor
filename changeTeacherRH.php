...
if(isset($_POST["submit"])){
    if(isset($_POST["coursenum"])) $courseNumber=$_POST["coursenum"];
echo($courseNumber);
    if(isset($_POST["teacher"])) $teacher=$_POST["teacher"];

    if(empty($courseNumber) || $teacher == ""){
            $error=true;
    } 
    if (!$error){
        require_once("db.php");
        $sql = "UPDATE classes set teacher='$teacher'
...
<body id="page-top">
    ...
    <form class="text-left" method="post">              
        <button class="btn btn-primary" type="submit" name="submit">Update Class</button>
        <br />
        <br />
        <label class="form-label">Course<select name="coursenum" value=""> &nbsp;
        <?php
                require_once("db.php");
                ...
                if ($error && $courseNumber=="") {
                    echo "<label class='errlabel'>select course</label>";
                }
            ?>
            </select>
        </label>
        ...
        <br />        
        <label class="form-label">New Teacher<br /><input type="text" name="teacher" value="<?php echo $teacher; ?>">
            <?php
